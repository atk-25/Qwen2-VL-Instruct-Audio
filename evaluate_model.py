...
def arg_parser():
    ...
    parser.add_argument("--number_samples_for_eval", type=int, default=None)   # if None all the samples in the test dataset will be used
...
def get_eval_dataset(args):
    ...
    if args.number_samples_for_eval is not None:
        test_dataset = test_dataset.select(range(args.number_samples_for_eval))  # use smaller number of samples for accelerated testing
